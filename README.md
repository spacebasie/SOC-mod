...
EECS 498 Project by Stefanos A Frilingos and Marco T Pajaro. 
...
```
cd existing_repo
git remote add origin https://gitlab.eecs.umich.edu/frilis/soc-mod.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.eecs.umich.edu/frilis/soc-mod/-/settings/integrations)
